<?php
session_start(); # To use login credentials
...
<body>
	...
	<ul class="cd-tabs-content" style="color: black;">
		...
		<li data-content="logout">
			<button style='color: white; border:none; background-color: #0066cc; border-color: #0066cc; margin-top: 10px; padding: 10px;' onclick="window.location.href = 'login.html'">Logout</button>
